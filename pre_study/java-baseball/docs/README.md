...
- [x] indent depth 2까지 허용 (while 안에 if문)
- [x] 3항 연산자 쓰지 않기
- [x] 함수가 한가지 일만 하도록 최대한 작게 만들기
- [x] JUnit 5와 AssertJ를 이용하여 본인이 정리한 기능 목록이 정상 동작함을 테스트 코드로 확인 (`test/java/study` 학습 하기)
- [x] [커밋 메세지 컨벤션](https://gist.github.com/stephenparish/9941e89d80e2bc58a153) 참고하여 커밋 메세지 작성, 위 기능 목록 단위로 커밋
